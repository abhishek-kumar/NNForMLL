...
main.o: lib
	g++ -DHAVE_CONFIG_H -I. -msse2 -DUSE_SSE -O3 -ffast-math  -Wall -msse2 -DUSE_SSE -O3 -ffast-math  -Wall -MT main.o -MD -MP -MF ".deps/sample.Tpo" -g -c src/main.cc src/BN_MLL.cc src/logging.cc src/io.c src/parameters.cc src/BR_MLL.cc src/cross_validate.cc src/SLN_MLL.cc
